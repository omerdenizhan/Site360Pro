    ...
    <div class="page-body">
        <div class="container-xl">
            ...
            <div class="row row-cards">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            @empty
                                <div class="list-group-item text-secondary">Bu dönem için tahsilat kaydı bulunmamaktadır.</div>
                            @endforelse
                        </div>
                    </div>
                </div>
                ...
                <div class="col-4">
                    <div class="card">
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            @empty
                                <div class="list-group-item text-secondary">Bu dönem için takip edilecek borç kaydı bulunmamaktadır.</div>
                            @endforelse
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header"><h3 class="card-title">Son Gelirler</h3></div>
                        <div class="list-group list-group-flush">
                            @forelse ($incomes->take(4) as $income)
                                <div class="list-group-item">
                                    <div class="d-flex justify-content-between gap-3">
                                        <div>
                                            <div class="fw-semibold">{{ $income->category }}</div>
                                            <div class="text-secondary small">{{ $income->description }}</div>
                                        </div>
                                        <div class="text-danger fw-bold">{{ $money($income->amount) }}</div>
                                    </div>
                                </div>
                            @empty
                                <div class="list-group-item text-secondary">Bu dönem için gelir kaydı bulunmamaktadır.</div>
                            @endforelse
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            @empty
                                <div class="list-group-item text-secondary">Bu dönem için gider kaydı bulunmamaktadır.</div>
                            @endforelse
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            @empty
                                <div class="list-group-item text-secondary">Bu dönem için duyuru kaydı bulunmamaktadır.</div>
                            @endforelse
