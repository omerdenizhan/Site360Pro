...
@section('content')
        ...
        <div class="container-xl">
            <div class="row g-3 align-items-center">
                <div class="col">
                    ...
                    <div class="text-secondary mt-1">Site kasasına giren aidat dışı ve diğer gelirler</div>
                </div>
    ...
    <div class="page-body">
        <div class="container-xl">
            @if (session('status'))
                <div class="alert alert-dan"><x-icon name="circle-check" class=" me-2" />{{ session('status') }}</div>
            @endif
            @if ($errors->any())
                ...
                <div class="card-body border-bottom">
                    <form class="d-flex justify-content-between align-items-end w-100" method="get" action="{{ route('incomes.index') }}">
                        ...
                        <div class="col-2 col-md-2 col-lg-2">
                            ...
                            <select class="form-select" name="month"><option value="">Tüm aylar</option>
                    ...
                    <table class="table table-vcenter card-table">
                        ...
                        @forelse ($incomes as $income)
                            <tr>
                                ...
                                <td class="text-end text-success fw-bold">{{ $money($income->amount) }}</td>
                                <td>
