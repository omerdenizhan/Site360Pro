...
<head>
    ...
    <style>
        ...
        WHATSAPP
        ============================================================ */
        @keyframes wa-circle-pulse-shake {
            0% {
                transform: scale(1);
        ...
        .wa-circle-animated {
            animation: wa-circle-pulse-shake 2.5s infinite ease-in-out;
            transition: transform 0.2s ease;
        }

        .wa-circle-animated:hover {
        ...
        ============================================================ */
        body {
            padding-bottom: 28px; /* İnce footer yüksekliği kadar alt boşluk */
        }
        .app-footer-fixed {
            position: fixed;
            bottom: 0;
        ...
        .app-footer-fixed span {
            font-size: 0.75rem; /* Metin boyutunu da ince tasarıma uygun küçültür */
            line-height: 1.2;
        }
    </style>
...
<body>
    ...
    <a class="btn btn-success rounded-circle d-inline-flex align-items-center justify-content-center p-0 shadow-lg wa-circle-animated"
        style="position: fixed; left: 20px; bottom: 40px; width: 36px; height: 36px; z-index: 9999;"
        ...
        rel="noopener"
        title="Canlı Destek">
        {{-- Buton boyutu (54px) sabit tutularak ikon boyutu 44px yapıldı --}}
        <x-icon name="brand-whatsapp" style="width: 20px; height: 20px;" />
    </a>
