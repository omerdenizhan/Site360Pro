    ...
    <div class="app-shell">
        <aside class="app-sidebar d-print-none" id="appSidebar">
            <a class="sidebar-brand" href="{{ route('dashboard') }}">
                <span class="brand-mark"><x-icon name="building-skyscraper" style="font-size: 1.9rem;"/></span>
                <span>
        ...
        <div class="app-main">
                ...
                <div class="ms-auto d-flex align-items-center gap-2">
                    ...
                    <div class="dropdown">
                        <button class="btn user-menu" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <span class="avatar avatar-sm bg-primary-lt"><x-icon name="building-skyscraper" style="font-size: 1.3rem;"/></span>
            ...
            <footer class="app-footer d-print-none">
                <div class="container-xl">
                    <span class="fw-semibold">Site360Pro v1.0.8 (Lisanssız)</span>
                    <span class="text-secondary">Geliştirici: Ömer Denizhan</span>
                </div>
            </footer>
        </div>
    </div>
