        ...
        <div class="container-xl">
            ...
            <div class="card">
                ...
                <div class="card-body border-bottom">
                    <form class="row g-2 d-flex align-items-end w-100" method="get" action="{{ route('payments.index') }}">
                        ...
                        <div class="col-3 col-md-3 col-lg-3">
                            ...
                            <input class="form-control" name="search" value="{{ $search }}" placeholder="Makbuz, daire veya sakin ara">
                        </div>
                        <div class="col-auto">
                        ...
                        @forelse ($payments as $payment)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="text-secondary small">{{ $payment->due->apartment->buildingBlock->name }}</div>
                                </td>
