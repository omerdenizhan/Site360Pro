            ...
            <div class="row row-cards mb-3">
                <div class="col-sm-6 col-xl-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-secondary fw-semibold" style="color: deepskyblue !important;">Toplam borçlandırma</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-xl-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-secondary fw-semibold" style="color: orange !important;">%{{ $report['collection_rate'] }} tahsilat</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-xl-3">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="text-secondary fw-semibold" style="color: red !important;">{{ $month ? 'Dönem Gideri' : 'Yıllık Gider' }}</span>
                            ...
                            <div class="text-secondary fw-semibold" style="color: red !important;">Kayıtlı gider toplamı</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-xl-3">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="text-secondary fw-semibold" style="color: green !important;">Net Kasa Etkisi</span>
                            ...
                            <div class="text-secondary fw-semibold" style="color: green !important;">Tahsilat - gider</div>
                        </div>
                    </div>
                </div>
            </div>
