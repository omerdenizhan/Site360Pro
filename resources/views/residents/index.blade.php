        ...
        <div class="container-xl">
            ...
            <div class="card">
                ...
                <div class="card-body border-bottom">
                    <form class="d-flex justify-content-between align-items-end w-100" method="get" action="{{ route('residents.index') }}">
                ...
                <div class="table-responsive">
                    <table class="table table-vcenter card-table">
                        ...
                        @forelse ($residents as $resident)
                            <tr>
                                <td class="fw-semibold">{{ $resident->apartment->number }}</td>
                                <td>
                                ...
                                <td>
                                    <span class="badge {{ $resident->is_active ? 'bg-green-lt' : 'bg-secondary-lt' }}">{{ $resident->is_active ? 'Aktif' : 'Pasif' }}</span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="btn-list flex-nowrap">
                                        <a class="btn btn-sm btn-outline-primary" href="{{ route('owner-reports.show', $resident->apartment) }}" target="_blank" rel="noopener">
                                        ...
                                        <form method="post"
                                            action="{{ route('residents.destroy', $resident) }}"data-confirm="Sakin silinsin mi?">
                                            @csrf
                                            @method('delete')
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center text-secondary py-5">Kayıt bulunamadı.</td>
                            </tr>
                        @endforelse
                        </tbody>
                    </table>
