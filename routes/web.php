...
Route::get('/owner-reports/apartment/{apartment}', [OwnerReportController::class, 'showByApartment'])->name('owner-reports.show');
Route::get('/owner-reports/{token}', [OwnerReportController::class, 'show'])->name('owner-reports.public-show');

Route::get('/apartments/{apartment}/report/pdf', [OwnerReportController::class, 'exportPdfByApartment'])->name('apartment.report.pdf');
Route::get('/reports/token/{token}/pdf', [OwnerReportController::class, 'exportPdf'])->name('owner-reports.pdf');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/settings/database/backup/sql', [DatabaseSettingsController::class, 'sql'])->name('settings.database.sql');
    Route::get('/settings/database/backup/json', [DatabaseSettingsController::class, 'json'])->name('settings.database.json');
    Route::post('/settings/database/restore', [DatabaseSettingsController::class, 'restore'])->name('settings.database.restore');
    Route::post('/settings/database/wipe', [DatabaseSettingsController::class, 'wipe'])->name('settings.database.wipe');
